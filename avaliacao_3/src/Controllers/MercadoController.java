...
public class MercadoController {
    ...
    public static void main(String[] args) {
        ...
        Pedido pedido1 = new Pedido(1, new Date(), totalPedido1, List.of(item1, item2, item3), vendedor1);
        Pedido pedido2 = new Pedido(2, new Date(), totalPedido2, List.of(item4, item5, item6, item7, item7, item8), vendedor2);
